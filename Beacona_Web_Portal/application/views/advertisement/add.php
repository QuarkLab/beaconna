            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <div class="card-content">
                        <form  method="POST" action="<?php echo base_url(); ?>index.php/Advertisement/add" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-7" style="">
                                    ...
                                    <div class="form-group label-floating is-empty">
                                        ...
                                        <textarea class="form-control tagarea" rows="3" name="description"></textarea>
                                        <span class="material-input"></span>
                                    </div>
                                </div>
